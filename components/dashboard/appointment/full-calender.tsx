...
const CalendarDayView = () => {
  ...
  return (
    <div className="flex relative py-4 h-full">
      <TimeTable />
...
const CalendarWeekView = () => {
  ...
  return (
    <div className="flex flex-col relative py-4 h-full">
      ...
      <div className="grid grid-cols-7 gap-px sticky top-0 bg-background border-b">
        {weekDays.map((day, i) => (
          <div
            key={day}
            className={cn(
              "mb-2 text-right text-lg text-muted-foreground pr-2",
              [0, 6].includes(i) && "text-muted-foreground/50",
            )}
          >
            {day}
            ...
            >
              <span
                className={cn(
                  ...
                  isToday(_date) && "bg-primary text-primary-foreground p-0.5",
                )}
              >
                {format(_date, "d")}
              </span>
